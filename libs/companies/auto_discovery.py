...
This module implements the main auto-discovery workflow that combines
domain resolution, careers page discovery, and portal detection to
automatically generate company seed configurations.
"""
